    ...
    return (
        <div className="page timelinePage">
            <div className="timelineContainer">
                ...
                <Link to='/Portfolio/contact' style={{ textDecoration: 'none' }}><div className="fadeButton fadeButtonExperienceMobile bold" onClick={() => buttonClick('contact')}> Contact me &gt; </div></Link>
            </div>
        </div>
    );
}
